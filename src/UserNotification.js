...
export default class UserNotification extends RX.Component {
  ...
  filterListPolicyId = event => {
    ...
    updatedList1 = updatedList.filter(function(item) {
      return (
        item.policyid.toLowerCase().search(event.target.value.toLowerCase()) !==
        -1
      );
    });
  ...
  filterListPaymentRule = event => {
    ...
    updatedList1 = updatedList.filter(function(item) {
      return (
        item.rules.toLowerCase().search(event.target.value.toLowerCase()) !== -1
      );
    });
    this.setState({ items: updatedList1 });
                    ...
                    <th>
                      ...
                      <tbody>
                        <input
                          ...
                          onChange={this.filterListPolicyId}
                        />
                      </tbody>
                    </th>
                    <th>
                      ...
                      <tbody>
                        <input
                          ...
                          onChange={this.filterListPolicyName}
                        />
                      </tbody>
                    </th>
                    ...
                    <th>
                      ...
                      <tbody>
                        <input
                          ...
                          onChange={this.filterListPolicyCategory}
                        />
                      </tbody>
                    </th>
                    <th>
                      ...
                      <tbody>
                        <input
                          ...
                          onChange={this.filterListPremium}
                        />
                      </tbody>
                    </th>
                    <th>
                      ...
                      <tbody>
                        <input
                          ...
                          style={styles.inputtable}
                          placeholder="Enter Name"
                          onChange={this.filterListPaymentRule}
                        />
                      </tbody>
                    </th>
                    ...
                    <th>
                      ...
                      <tbody>
                        <input
                          ...
                          onChange={this.filterListCollateral}
                        />
                      </tbody>
                    </th>
                    <th>
